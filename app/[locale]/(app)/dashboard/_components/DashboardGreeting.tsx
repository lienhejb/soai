...
export function DashboardGreeting({ honorific, fullName, todayLunar, onEdit }: Props) {
  return (
    <div className="px-5 pb-5 pt-8">
      <div className="flex items-start justify-between gap-3">
        ...
        <button
          ...
          className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full border border-amber-500/40 bg-white text-amber-600 shadow-sm transition hover:border-amber-500 hover:bg-amber-50"
        >
          <PenIcon />
        </button>
      </div>
